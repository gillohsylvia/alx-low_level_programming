# 0x1A. C - Hash tables
# Resources
* [What is a HashTable Data Structure - Introduction to Hash Tables , Part 0](https://en.wikipedia.org/wiki/Hash_function)
* [Hash function](https://en.wikipedia.org/wiki/Hash_table)
* [Hash table](https://www.digitalocean.com/community/tutorials/hash-table-in-c-plus-plus)
* [All about hash tables](https://stackoverflow.com/questions/31930046/what-is-a-hash-table-and-how-do-you-make-it-in-c)
* [why hash tables and not arrays](https://www.youtube.com/watch?v=MfhjkfocRR0)
